...
<head>
    ...
    <title>@yield('title', 'IELTS Mock Test by UKG')</title>
...
<body>
    <nav class="navbar navbar-dark px-3">
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ auth()->check() && auth()->user()->is_admin ? route('admin.dashboard') : route('user.dashboard') }}">
            <img src="{{ asset('images/logo.png') }}" alt="UKG"> IELTS Mock Test by UKG
        </a>
        @auth
