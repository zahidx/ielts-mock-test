...
<div class="card login-card">
    <div class="login-header"><img src="<?php echo e(asset('images/logo.png')); ?>" alt="UKG"><h4 class="mb-0 text-dark">IELTS Mock Test by UKG</h4><small class="text-muted">Computer-Based Practice Platform</small></div>
    <div class="card-body p-4">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>"><?php echo csrf_field(); ?>
            <div class="mb-3"><label class="form-label fw-semibold">User ID</label><input type="text" name="user_id" class="form-control form-control-lg" value="<?php echo e(old('user_id')); ?>" required autofocus></div>
...
</body></html><?php /**PATH D:\ielts-mock-test\ielts-mock-test\resources\views/auth/login.blade.php ENDPATH**/ ?>